...
model small
dataseg
    line db 23h,43h,23h,43h,23h,43h,23h,43h,23h,43h,23h,43h,23h,43h,23h,43h,23h,43h,23h,43h; 0.100.0011.B
...
codeseg
    Start:
        ...
        mov es, ax
        mov ax, 1358  ;(Y: (10(координата)-2(цикл и отступ))*80(ширина экрана)*2(байт) + X: (40(координата)-1(отступ))*2(байт) = 1680)
